...
public class UIHelper {
	...
	public static void jumpActivityWithBundle(Context context, Class<?> cls,
			Bundle bundle) {
	...
	public static void jumpActivityForResult(Context context, Class<?> cls,
			int requestCode) {
		jumpActivityWithBundleForResult(context, cls, null, requestCode);
	}

	public static void jumpActivityWithBundleForResult(Context context,
